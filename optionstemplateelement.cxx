...
OptionsTemplateElement::OptionsTemplateElement(TextTemplate *t, const QString &name, const QString &typeName, const QStringList &options)
    : TemplateElement(t, name, typeName, options)
{
}

QString OptionsTemplateElement::implToString() const
{
    QStringList buf;

    for (auto& e : elementValues()) {
        buf.push_back(e->name());
    }
