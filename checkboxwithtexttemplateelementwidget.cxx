...
CheckBoxWithTextTemplateElementWidget::CheckBoxWithTextTemplateElementWidget(QWidget *p, TemplateElementSPtr e)
    : TemplateElementWidget(p, e)
{
    ...
    for (auto& option : e->elementOptions()) {
        ...
        connect(b, &QCheckBox::toggled, this, &CheckBoxWithTextTemplateElementWidget::onToggled);
        connect(e, &QLineEdit::textChanged, this, &CheckBoxWithTextTemplateElementWidget::onTextChanged);
    }
}

void CheckBoxWithTextTemplateElementWidget::onToggled(bool isChecked)
{
    (void) isChecked;
    updateData();
}

void CheckBoxWithTextTemplateElementWidget::onTextChanged(const QString &txt)
{
    (void) txt;
    updateData();
}

void CheckBoxWithTextTemplateElementWidget::updateData()
{
